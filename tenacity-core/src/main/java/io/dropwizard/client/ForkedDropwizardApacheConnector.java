 ...
 * </p>
 */
public class ForkedDropwizardApacheConnector implements Connector {

    private static final String APACHE_HTTP_CLIENT_VERSION = VersionInfo.loadVersionInfo
            ("org.apache.http.client", ForkedDropwizardApacheConnector.class.getClassLoader())
            .getRelease();
    ...
    public ForkedDropwizardApacheConnector(CloseableHttpClient client, RequestConfig defaultRequestConfig, boolean chunkedEncodingEnabled) {
        this.client = client;
     ...
     * <p>
     * In contrast to {@link ForkedDropwizardApacheConnector.JerseyRequestHttpEntity}
