 ...
 * </p>
 */
public class FixedDropwizardApacheConnector implements Connector {

    private static final String APACHE_HTTP_CLIENT_VERSION = VersionInfo.loadVersionInfo
            ("org.apache.http.client", FixedDropwizardApacheConnector.class.getClassLoader())
            .getRelease();
    ...
    public FixedDropwizardApacheConnector(CloseableHttpClient client, boolean chunkedEncodingEnabled) {
        this.client = client;
    ...
    private HttpUriRequest buildApacheRequest(ClientRequest jerseyRequest) {
        ...
        if(jerseyRequest.getConfiguration().getProperty(ClientProperties.READ_TIMEOUT) != null) {
            RequestConfig requestConfig =  RequestConfig.custom()
                    .setSocketTimeout((Integer)jerseyRequest.getConfiguration().getProperty(ClientProperties.READ_TIMEOUT))
                    .build();
