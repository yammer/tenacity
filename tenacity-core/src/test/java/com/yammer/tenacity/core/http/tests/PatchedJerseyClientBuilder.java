 ...
 */
public class PatchedJerseyClientBuilder {
    ...
    public PatchedJerseyClientBuilder(Environment environment) {
        this.apacheHttpClientBuilder = new HttpClientBuilder(environment);
        this.environment = environment;
    }

    public PatchedJerseyClientBuilder(MetricRegistry metricRegistry) {
     ...
     * @return {@code this}
     */
    public PatchedJerseyClientBuilder withProvider(Object provider) {
     ...
     * @return {@code this}
     */
    public PatchedJerseyClientBuilder withProvider(Class<?> klass) {
     ...
     * @return {@code this}
     */
    public PatchedJerseyClientBuilder withProperty(String propertyName, Object propertyValue) {
     ...
     * @return {@code this}
     */
    public PatchedJerseyClientBuilder using(JerseyClientConfiguration configuration) {
     ...
     */
    public PatchedJerseyClientBuilder using(Environment environment) {
        this.environment = environment;
        return this;
    }
     ...
     * @return {@code this}
     */
    public PatchedJerseyClientBuilder using(Validator validator) {
     ...
     */
    public PatchedJerseyClientBuilder using(ExecutorService executorService, ObjectMapper objectMapper) {
     ...
     * @return {@code this}
     */
    public PatchedJerseyClientBuilder using(ConnectorProvider connectorProvider) {
     ...
     * @return {@code this}
     */
    public PatchedJerseyClientBuilder using(HttpRequestRetryHandler httpRequestRetryHandler) {
     ...
     * @return {@code this}
     */
    public PatchedJerseyClientBuilder using(DnsResolver resolver) {
     ...
     * @return {@code this}
     */
    public PatchedJerseyClientBuilder using(Registry<ConnectionSocketFactory> registry) {
     ...
     * @return {@code this}
     */
    public PatchedJerseyClientBuilder using(HttpClientMetricNameStrategy metricNameStrategy) {
     ...
     * @return {@code this}
     */
    public PatchedJerseyClientBuilder name(String environmentName) {
     ...
     * @return {@code this}
     */
    public PatchedJerseyClientBuilder using(HttpRoutePlanner routePlanner) {
     ...
     * @return {@code this}
     */
    public PatchedJerseyClientBuilder using(CredentialsProvider credentialsProvider) {
        ...
        if (connectorProvider == null) {
            ...
            connectorProvider = new ConnectorProvider() {
                ...
                public Connector getConnector(Client client, Configuration runtimeConfig) {
                    return new FixedDropwizardApacheConnector(apacheHttpClient, configuration.isChunkedEncodingEnabled());
                }
            };
        }
    ...
    // added this here, as package protected
    static class DropwizardExecutorProvider implements RequestExecutorProvider {
